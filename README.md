...
**The Project:**
The calendar is the sample for a full-stack app capable of adding/deleting/displaying events and user authentication with tokens.
...
- Create a MySQL superuser with named calendar.
...
- curl -X POST -d '{
    "event":{
        ...
        "details":"Release the calendar project",
